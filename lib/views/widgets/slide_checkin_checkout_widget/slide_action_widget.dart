...
import 'package:enterprise/views/widgets/slide_checkin_checkout_widget/slide_action_state_mixin.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';

import 'frame_change_callback_provider.dart';
...
class SlideAction extends StatefulWidget {
  ...
  SlideAction({
    ...
    this.trackHeight = 64,
    this.thumbWidth,
    this.snapAnimationDuration = const Duration(milliseconds: 100),
